...
export default function fleetPlacementStateListeners(fleetPlacementManager) {
  ...
  const listeners = {
    init: function () {
      ...
      fleetPlacementManager.submitButton.addEventListener(
        'click',
        fleetPlacementManager.submitPlacements
      );
      fleetPlacementManager.rotateButton.addEventListener(
        'click',
        fleetPlacementManager.shipRotated
      );
    },
    remove: function () {
      ...
      fleetPlacementManager.submitButton.removeEventListener(
        'click',
        fleetPlacementManager.submitPlacements
      );
      fleetPlacementManager.rotateButton.removeEventListener(
        'click',
        fleetPlacementManager.shipRotated
      );
    }
